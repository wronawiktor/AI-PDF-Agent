...
class ExtractTextTableInfoWithRenditionsFromPDF:
    ...
    def create_output_file_path() -> str:
        ...
        os.makedirs("output/ExtractTextTableInfoWithRenditionsFromPDF", exist_ok=True)
        return f"output/ExtractTextTableInfoWithRenditionsFromPDF/extract{time_stamp}.zip"
